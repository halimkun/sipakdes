...
<div style="text-align: justify; line-height: 1.5;">
  <div class="text-center mb-4">
    <h6 class="mb-0 pb-0">SURAT PENGANTAR KETERANGAN CATATAN KEPOLISIAN</h6>
  ...
  <div class="px-3 pb-3">
    <table style="width: 100%;">
      ...
      <tr>
        ...
        <td style="width:10px; vertical-align: top;">:</td>
        <td style="vertical-align: top;"><?= $pengantar->status_perkawinan ?></td>
      </tr>
      <tr>
        <th style="width: 40%; vertical-align: top;">Pendidikan</th>
        <td style="width:10px; vertical-align: top;">:</td>
        <td style="vertical-align: top;"><?= $pengantar->pendidikan ?></td>
      </tr>
      <tr>
        <th style="width: 40%; vertical-align: top;">Pekerjaan</th>
        <td style="width:10px; vertical-align: top;">:</td>
        <td style="vertical-align: top;"><?= $pengantar->jenis_pekerjaan ?></td>
      </tr>
      <tr>
  ...
  <p class="mb-2 pb-2">Orang tersebut diatas adalah benar-benar warga desa <?= strtolower(service('settings')->get('App.desa')) ?> kecamatan <?= strtolower(service('settings')->get('App.kecamatan')) ?> kabupaten <?= strtolower(service('settings')->get('App.kabupaten')) ?> yang ingin mengajukan permohonan pembuatan keterangan catatan kepolisian (SKCK) yang akan dipergunakan untuk keperluan <u><?= $pengantar->keperluan ?></u>.</p>
