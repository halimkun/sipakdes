...
<div style="text-align: justify; line-height: 1.5;">
  <div class="text-center mb-4">
    <h6 class="mb-0 pb-0">SURAT PENGANTAR IDENTITAS ANAK</h6>
  ...
  <p class="mb-2 pb-2">Anak tersebut diatas adalah benar-benar warga desa <?= strtolower(service('settings')->get('App.desa')) ?> kecamatan <?= strtolower(service('settings')->get('App.kecamatan')) ?> kabupaten <?= strtolower(service('settings')->get('App.kabupaten')) ?> yang ingin mengajukan permohonan pembuatan kartu identitas anak (KIA) yang akan dipergunakan untuk keperluan <u><?= $pengantar->keperluan ?></u>.</p>
