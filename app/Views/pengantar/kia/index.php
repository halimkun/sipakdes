...
<div class="row">
  <div class="col-12 col-md-9">
    <div class="card card-outline card-success">
      <div class="card-header">
        <h4 class="card-title">
          <i class="fa fa-fingerprint mr-1"></i> Pengajuan KIA
        </h4>
      </div>
                    ...
                    <?php if (!in_groups('warga')) : ?>
                      ...
                      <div class="btn-group">
                        ...
                        <div class="dropdown-menu">
                          <a class="dropdown-item" href="/surat/pengantar/kia/<?= $kia->pengantar_id ?>/print"><i class="fa fa-print mr-1"></i> Cetak</a>
                      ...
                      <div class="btn-group btn-group-sm" role="group" aria-label="Aksi Penduduk">
                        <?php if (!in_array($kia->status, ['pending'])) : ?>
                          <?php if ($kia->status == 'selesai') : ?>
                            <a href="/surat/pengantar/kia/<?= $kia->pengantar_id ?>/print" class="btn btn-sm btn-primary" data-toggle="tooltip" title="cetak"><i class="fa fa-print"></i></a>
                          <?php endif ?>
                        ...
                        <?php else : ?>
                          <!-- <a href="/surat/pengantar/kia/<?= $kia->pengantar_id ?>/batal" data-toggle="tooltip" title="batal" class="btn btn-sm btn-secondary" onclick="return confirm('Apakah anda yakin ingin membatalkan surat ini?')"><i class="fa fa-times-circle"></i></a> -->
                        <?php endif ?>
                      </div>
                    <?php endif ?>
                  </td>
  ...
  <div class="col-12 col-md-3">
    <div class="card card-outline card-info">
      ...
      <div class="card-body">
        <p class="text-muted">
          KIA adalah bukti identitas resmi untuk anak di bawah 17 tahun yang berlaku selayaknya KTP untuk orang dewasa pada umumnya. Anda dapat melakukan permintaan pembuatan KIA melalui aplikasi ini.
        </p>

        <!-- button block -->
        <a href="/surat/pengantar/kia/new" class="btn btn-block btn-info">
...
<?php if (!in_groups(['warga'])) : ?>
  <script>
    ...
    $('.btn-update-status').on('click', function(e) {
      ...
      $('#modal-update-status form').attr('action', `/surat/pengantar/kia/${id}/update-status`);
    });
  </script>
<?php endif ?>
<?= $this->endSection(); ?>